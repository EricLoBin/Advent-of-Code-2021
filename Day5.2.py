...
for line in inp:
    if (line[0][0] == line[1][0]):
        ...
        dist = (line[0][0] - line[1][0]) if line[0][0] > line[1][0] else (line[1][0] - line[0][0])
        for i in range(dist+1):
            ar[(line[0][1]+i) if line[0][1] < line[1][1] else (line[0][1]-i)][(line[0][0]+i) if line[0][0] < line[1][0] else line[0][0]-i] += 1
